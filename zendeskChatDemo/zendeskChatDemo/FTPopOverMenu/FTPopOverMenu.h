...
@property (nonatomic, assign) CGFloat menuHeaderHeight;
@property (nonatomic, assign) CGFloat menuFooterHeight;
...
@property (nonatomic, assign) BOOL hideArrow; //隐藏箭头
@property (nonatomic, assign) BOOL needChangeContentViewFrame; //是否要修改cell.ContentView.frame
@property (nonatomic, assign) CGFloat contentViewRadius;
